...
public class AppointmentRepository {
    ...
    public List<Appointment> findAll(String username) {
        try {
            ...
            List<Appointment> result = jdbcTemplate.query(sql, new Object[]{username}, (rs, rowNum) -> new Appointment(rs.getInt("appID"), rs.getString("title"), rs.getString("time"), rs.getString("cusName"), rs.getString("denName"), rs.getString("description")));
